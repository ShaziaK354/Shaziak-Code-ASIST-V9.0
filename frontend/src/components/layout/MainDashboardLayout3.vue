...
// ===================================================================
// ✅ DATA OVERRIDE: Always use SR-P-NAV case data
// ===================================================================
const activeCaseDetails = computed(() => {
  // Override with SR-P-NAV data regardless of store
  return {
    id: 'SR-P-NAV',
    caseNumber: 'SR-P-NAV',
...
onMounted(() => {
  // Always default to SR-P-NAV on mount
  console.log('[MainDashboardLayout] Mounted - defaulting to SR-P-NAV');
