...
// ===================================================================
// ✅ DATA OVERRIDE: Hardcoded Saudi Arabia Cases
// ===================================================================
...
// Override case data - force Saudi Arabia cases
const casesByCountry = ref([
  {
    code: 'SA',
    name: 'Saudi Arabia',
    cases: hardcodedCases.value
  }
]);

const recentCasesData = ref(hardcodedCases.value.slice(0, 4));
const renderedPinnedCases = ref([]);
const expandedCountriesInSidebar = ref(['SA']); // Auto-expand Saudi Arabia
